...
import numpy as np
import pydicom
# from Utils import play_dicom_animation as pda
   ...
   # dicom_files = [file for file in os.listdir(dicom_folder_path) if file.endswith('.IMA') ] 
    ...
    for file_name in dicom_files:
        ...
        metadata = {
            ...
            'Acquisition Time' : dicom_dataset.AcquisitionTime, # 
            'Acquisition Number': dicom_dataset.AcquisitionNumber # Acquisition number for the slice
        }   
